...
public struct CreateTodoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, name: String, creationDate: Double) {
    graphQLMap = ["id": id, "name": name, "creationDate": creationDate]
  }
  ...
  public var creationDate: Double {
    get {
      return graphQLMap["creationDate"] as! Double
    }
    set {
...
public struct ModelTodoConditionInput: GraphQLMapConvertible {
  ...
  public init(name: ModelStringInput? = nil, creationDate: ModelFloatInput? = nil, and: [ModelTodoConditionInput?]? = nil, or: [ModelTodoConditionInput?]? = nil, not: ModelTodoConditionInput? = nil) {
    graphQLMap = ["name": name, "creationDate": creationDate, "and": and, "or": or, "not": not]
  }
  ...
  public var creationDate: ModelFloatInput? {
    get {
      return graphQLMap["creationDate"] as! ModelFloatInput?
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "creationDate")
    }
...
public struct UpdateTodoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, name: String? = nil, creationDate: Double? = nil) {
    graphQLMap = ["id": id, "name": name, "creationDate": creationDate]
  }
...
public struct ModelTodoFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, name: ModelStringInput? = nil, creationDate: ModelFloatInput? = nil, and: [ModelTodoFilterInput?]? = nil, or: [ModelTodoFilterInput?]? = nil, not: ModelTodoFilterInput? = nil) {
    graphQLMap = ["id": id, "name": name, "creationDate": creationDate, "and": and, "or": or, "not": not]
  }
...
public final class CreateTodoMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateTodo: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, name: String, creationDate: Double) {
        self.init(snapshot: ["__typename": "Todo", "id": id, "name": name, "creationDate": creationDate])
      }
      ...
      public var creationDate: Double {
        get {
          return snapshot["creationDate"]! as! Double
        }
        set {
